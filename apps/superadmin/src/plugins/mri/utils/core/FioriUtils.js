sap.ui.define(
  ...
  function (jQuery, Device) {
     ...
     * @alias sap.hc.hph.core.ui.FioriUtils
     */
    var FioriUtils = {};
    /**
     ...
     * @private
     * @type {sap.hc.hph.core.ui.FioriUtils.DensityClass[]}
     */
     ...
     * @param {sap.hc.hph.core.ui.FioriUtils.DensityClass} sDensityClass Density class in question
     ...
     * If the scope does not exist, the default support information is used.
     * @param {string} sKey Scope
     * @returns {sap.hc.hph.core.ui.FioriUtils.DensityClass[]} List of supported classes
     */
