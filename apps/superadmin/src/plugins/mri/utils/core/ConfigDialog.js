sap.ui.define(
  ...
  function (jQuery, Dialog, Toolbar, Control) {
     ...
     * @alias sap.hc.hph.core.ui.ConfigDialog
     */
    var ConfigDialog = Dialog.extend("sap.hc.hph.core.ui.ConfigDialog", {
      metadata: {
     ...
     * @returns {sap.hc.hph.core.ui.ConfigDialog} Reference to this in order to allow method chaining.
     */
