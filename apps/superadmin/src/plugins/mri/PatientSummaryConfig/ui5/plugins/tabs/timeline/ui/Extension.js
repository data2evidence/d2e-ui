sap.ui.define([
     ...
     */
    var TabExtension = TabExtensionBase.extend("sap.hc.hph.patient.plugins.tabs.timeline.ui.Extension", {
    ...
    TabExtension.prototype.getContent = function (/* mNavTargets */) {
        var oContentView = sap.ui.xmlview({
            viewName: "sap.hc.hph.patient.plugins.tabs.timeline.ui.view.Timeline"
        });
