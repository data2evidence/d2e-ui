sap.ui.define([
    ...
    "sap/hc/hph/patient/plugins/widgets/documents/ui/lib/Utils",
     ...
     * @alias sap.hc.hph.patient.plugins.widgets.documents.ui.Extension
     */
    var WidgetComponent = WidgetExtensionBaseComponent.extend("sap.hc.hph.patient.plugins.widgets.documents.ui.Extension", {
        metadata: {
            includes: [
                "css/style.css"
            ],
            rootView: "sap.hc.hph.patient.plugins.widgets.documents.ui.view.Documents",
            config: {
                rootPath: "/sap/hc/hph/patient/plugins/widgets/documents/ui",
