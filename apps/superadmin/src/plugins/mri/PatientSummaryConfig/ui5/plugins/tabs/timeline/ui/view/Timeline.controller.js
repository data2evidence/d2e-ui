sap.ui.define([
     ...
     */
    var TimelineController = TabBaseController.extend("sap.hc.hph.patient.plugins.tabs.timeline.ui.view.Timeline");
    ...
    TimelineController.prototype.createLane = function (sId, oContext) {
        ...
        if (sLaneType === "ChartLane") {
            var oChart = sap.ui.xmlfragment("sap.hc.hph.patient.plugins.tabs.timeline.ui.view.Chart", this);
            ...
            return sap.ui.xmlfragment("sap.hc.hph.patient.plugins.tabs.timeline.ui.view.Lane", this);
        }
    };
    ...
    TimelineController.prototype.handleUndatedBadgeClick = function (oEvent) {
        ...
        if (!this.undatedTilesPopover) {
            this.undatedTilesPopover = sap.ui.xmlfragment("sap.hc.hph.patient.plugins.tabs.timeline.ui.view.UndatedTilesPopover", this);
    ...
    TimelineController.prototype.onOpenChartVisualizationDialog = function (oEvent) {
        ...
        if (!this.chartSelectionDialog) {
            this.chartSelectionDialog = sap.ui.xmlfragment("sap.hc.hph.patient.plugins.tabs.timeline.ui.view.ChartSelection", this);
    ...
    TimelineController.prototype.onOpenAddChartDialog = function (oEvent) {
        ...
        if (!this.attributeSelectionDialog) {
            this.attributeSelectionDialog = sap.ui.xmlfragment("sap.hc.hph.patient.plugins.tabs.timeline.ui.view.AttributeSelection", this);
