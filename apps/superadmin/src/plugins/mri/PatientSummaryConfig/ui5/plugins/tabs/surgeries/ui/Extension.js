sap.ui.define([
    "jquery.sap.global",
    "sap/hc/hph/patient/plugins/tabs/surgeries/ui/lib/Utils",
    ...
    /**
     * Patient Summary Surgeries Tab Extension.
     * @constructor
     *
     * @extends sap.hc.hph.patient.ui.content.extension.TabExtensionBase
     * @alias sap.hc.hph.patient.plugins.tabs.surgeries.ui.Extension
     */
    var TabExtension = TabExtensionBase.extend("sap.hc.hph.patient.plugins.tabs.surgeries.ui.Extension", {
        constructor: function () {
            this.oResourceModel = new ResourceModel({
                bundleUrl: "/sap/hc/hph/patient/plugins/tabs/surgeries/ui/i18n/text.properties"
            });
    ...
    TabExtension.prototype.getContent = function (/* mNavTargets */) {
        var oContentView = sap.ui.xmlview({
            viewName: "sap.hc.hph.patient.plugins.tabs.surgeries.ui.view.Surgeries"
        });
    ...
    TabExtension.prototype.getText = function () {
        return Utils.getText("PS_PLUGINS_TABS_SURG_TAB_TITLE");
    };
