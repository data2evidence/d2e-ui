sap.ui.define([
     ...
     * @alias sap.hc.hph.patient.config.ui.lib.SortedMultiComboBox
     */
    var SortedMultiComboBox = MultiComboBox.extend("sap.hc.hph.patient.config.ui.lib.SortedMultiComboBox", {
        renderer: {}
    });
