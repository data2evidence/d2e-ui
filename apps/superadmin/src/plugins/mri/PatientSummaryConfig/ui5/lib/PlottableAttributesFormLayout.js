sap.ui.define([
     ...
     * @alias sap.hc.hph.patient.config.ui.lib.PlottableAttributesFormLayout
     */
    var PlottableAttributesFormLayout = FormLayout.extend("sap.hc.hph.patient.config.ui.lib.PlottableAttributesFormLayout", {});
