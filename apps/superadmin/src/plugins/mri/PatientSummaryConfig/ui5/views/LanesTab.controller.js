sap.ui.define(
  [
    ...
    "sap/m/MessageBox",
    "sap/ui/unified/Menu",
    "sap/hc/hph/patient/config/ui/views/MenuItem",
  ...
  function (jQuery, ConfigUtils, MessageBox, Menu, MenuItem, LocaleData, Controller) {
     ...
     * @alias sap.hc.hph.patient.config.ui.views.LanesTab
     */
    var LanesTabController = Controller.extend("sap.hc.hph.patient.config.ui.views.LanesTab");
    ...
    LanesTabController.prototype.onInit = function () {
      ...
      this._attributeTableRowFragment = sap.ui.xmlfragment(
        "sap.hc.hph.patient.config.ui.views.AttributeTableRow",
        this
      );
    };
     ...
     * @returns {sap.hc.hph.patient.config.ui.views.AttributeTableRow} an xml fragment containing a table row
     */
