sap.ui.define(
  ...
  function (
     ...
     * @alias sap.hc.hph.patient.config.ui.views.ConfigList
     */
    var ConfigListController = Controller.extend("sap.hc.hph.patient.config.ui.views.ConfigList", {
      metadata: {
        events: {
          /**
    ...
    ConfigListController.prototype.showValidationErrors = function (oConfig, sConfigPath) {
      ...
      if (!this._oConfigValidationErrorDialog) {
        this._oConfigValidationErrorDialog = sap.ui.xmlfragment(
          "sap.hc.hph.patient.config.ui.views.ConfigValidationErrors",
          this
        );
    ...
    ConfigListController.prototype.onPreviewConfigPressed = function (oEvent) {
      this.performAction(oEvent, function (configObj) {
        if (!this._oConfigPreviewDialog) {
          this._oConfigPreviewDialog = sap.ui.xmlfragment("sap.hc.hph.patient.config.ui.views.PreviewConfig", this);
    ...
    ConfigListController.prototype.onImportConfiguration = function (targetConfigPath) {
      if (!this._oImportDialog) {
        this._oImportDialog = sap.ui.xmlfragment("sap.hc.hph.patient.config.ui.views.ImportConfig", this);
      ...
      this.performAction(oEvent, function (piConfig, sConfigPath) {
        ...
        if (bSaved && !bModified) {
          ...
          if (!this._oExportDialog) {
            this._oExportDialog = sap.ui.xmlfragment("sap.hc.hph.patient.config.ui.views.ExportConfig", this);
