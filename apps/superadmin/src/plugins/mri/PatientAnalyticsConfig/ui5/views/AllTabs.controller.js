sap.ui.define([
     ...
     * @alias sap.hc.mri.pa.config.ui.views.AllTabs
     */
    var AllTabsController = Controller.extend("sap.hc.mri.pa.config.ui.views.AllTabs");
    ...
    AllTabsController.prototype._updateConfigBindings = function (sChannelId, sEventId, oEventData) {
        ...
        if (!mriConfig.config) {
            ...
            if (meta.configId !== "") {
                ...
                ConfigUtils.ajax({
                    url: "/sap/hc/mri/pa/config/db/configDefaultValues.json",
                    type: "GET",
                    dataType: "json",
                    contentType: "application/json;charset=utf-8"
                }).done(function (mData) {
