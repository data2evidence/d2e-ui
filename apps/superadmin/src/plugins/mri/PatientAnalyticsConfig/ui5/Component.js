...
sap.ui.define([
    ...
    var Component = UIComponent.extend("sap.hc.mri.pa.config.ui.Component", {
        metadata: {
            ...
            rootView: "sap.hc.mri.pa.config.ui.views.MainEditor"
        }
    });
    ...
    Component.prototype.init = function () {
        ...
        var oRBModel = new ResourceModel({
            bundleUrl: `/sap/hc/mri/pa/config/ui/${mConfig.resourceBundle}`
        });
        oRBModel.enhance({
    ...
    Component.prototype._fnAddHelpLink = function () {
        ...
        if (sap.ushell && sap.ushell.renderers) {
            ...
            this._oHelpLink = new sap.m.Button({
                ...
                press: [function () {
                    var sUrl = "https://help.sap.com/viewer/6277ccd6bd38468f97641fbadd3bf194/3.0.0/en-US/2180c5036cc54f60bd44ea4f02bf0daf.html";
