sap.ui.define([
    ...
    var DuplicateConfigurationController = Controller.extend("sap.hc.hph.cdw.config.ui.views.DuplicateConfiguration");    

// Declaration of the module. Will ensure that the containing namespace 'sap.hc.hph.cdw.config.ui.views' exists.
