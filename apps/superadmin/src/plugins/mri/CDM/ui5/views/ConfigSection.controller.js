sap.ui.define([
    ...
    var view = Controller.extend("sap.hc.hph.cdw.config.ui.views.ConfigSection", {
        onInit: function () {
                    ...
                    if (result === "error") {
                        ...
                        var configDialog = new Dialog({
                            ...
                            endButton: new Button({
                                text: '{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_PREVIEW_CONFIG_CLOSE}',
                                press: function () {
                                    configDialog.close();
                                }
                            }),
                            beginButton: new Button({
                                text: '{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_PREVIEW_CONFIG_COPY}',
                                tooltip: '{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_PREVIEW_CONFIG_COPY_TOOLTIP}',
                                press: function () {
                        ...
                        configDialog.setModel(that.getView().getModel("sap.hc.hph.cdw.config.ui.i18n"), "sap.hc.hph.cdw.config.ui.i18n");
                        configDialog.open();
                    }
                });
        },
