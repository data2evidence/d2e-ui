sap.ui.define([
    ...
    var ConfigEditorDetailsController = Controller.extend("sap.hc.hph.cdw.config.ui.views.ConfigEditorDetails");
    ...
    ConfigEditorDetailsController.prototype.onInit = function () {
        ...
        if (!this.filterCardItemView) {
            this.filterCardItemView = sap.ui.xmlview({ type: sap.ui.core.mvc.ViewType.XML, viewName: "sap.hc.hph.cdw.config.ui.views.FilterCardItem" });
        }

        if (!this.attributeView) {
            this.attributeView = sap.ui.xmlview({ type: sap.ui.core.mvc.ViewType.XML, viewName: "sap.hc.hph.cdw.config.ui.views.Attribute" });
        }
