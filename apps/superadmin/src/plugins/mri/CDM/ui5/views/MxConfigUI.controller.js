...
var MxConfigUIController = Controller.extend("sap.hc.hph.cdw.config.ui.views.MxConfigUI", {
    ...
    MxConfigUIController.prototype.onInit = function() {
        ...
        this._pageContainer.bindProperty("title",{path: "sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_APP_TITLE"});
    ...
    MxConfigUIController.prototype._configVersionItemChanged = function(sChannelId, sEventId, oEventData) {
        ...
        .bindProperty("title",
            {
                parts: ["sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_APP_TITLE", "configEditorModel>/configName", "sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_OVERVIEW_VERSION_NB", "configEditorModel>/configVersion"],
    ...
    MxConfigUIController.prototype.handleNavButtonPress = function () {
        ...
        if (currentPage.getViewName() === "sap.hc.hph.cdw.config.ui.views.ConfigSection") {
            this._onNavigateToMainConfig();
        }
    };
