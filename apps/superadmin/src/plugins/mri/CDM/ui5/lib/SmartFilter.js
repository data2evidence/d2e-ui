sap.ui.define([
     ...
     */
    return Control.extend("sap.hc.hph.cdw.config.ui.lib.SmartFilter", {
        metadata: {
            properties: {
        ...
        init: function () {
            ...
            this.setAggregation("placeholderLabel", new Label({
                text: "{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_PHOLDER_CHOOSE_PLACEHOLDER_LABEL}",
                tooltip: "{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_PHOLDER_CHOOSE_PLACEHOLDER_LABEL}"
            }).addStyleClass("sapMXSmartFilterLabel"));
            this.setAggregation("filterLabel", new Label({
                text: "{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_FILTER_EXPRESSION}",
                tooltip: "{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_FILTER_EXPRESSION}"
            }).addStyleClass("sapMXSmartFilterLabel"));
            ...
            var _basicButton = new SegmentedButtonItem({
                key: modes.BASIC,
                text: "{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_SMARTFILTER_BASIC}",
            ...
            var _advanceButton = new SegmentedButtonItem({
                key: modes.ADVANCE,
                text: "{sap.hc.hph.cdw.config.ui.i18n>HPH_CDM_CFG_SMARTFILTER_ADVANCE}",
                press: function (oEvent) {
