...
sap.ui.define([
    ...
    var Component = UIComponent.extend("sap.hc.hph.cdw.config.ui.Component", {
        metadata: {
            name: "Clinical Data Model Configuration",
            version: "${version}",
            dependencies: {
                libs: [
                    "sap.hc.hph.cdw.config.ui.lib",
                    "sap.hc.hph.core.ui",
                    "sap.m",
                    "sap.ui.commons",
                    "sap.ui.core",
            ...
            config: {
                ...
                modulePath: "/sap/hc/hph/cdw/config/ui",
                configService: {
                    modulePath: "/sap/hc/hph/config",
                    resourceBundle: "i18n/config.properties"
                }
            },
            rootView: "sap.hc.hph.cdw.config.ui.views.App"
        }
    });
    ...
    Component.prototype.init = function () {
        ...
        var sResourceBundlePackage = "sap.hc.hph.cdw.config.ui.i18n";
		...
		var sPatientResourceBundlePackage = "sap.hc.hph.patient.config.i18n";
		var oPatientRBModel = this.getModel(sPatientResourceBundlePackage);

        if (!oPatientRBModel) {

            oPatientRBModel = new ResourceModel({
                bundleUrl: "/sap/hc/hph/patient/config/i18n/text.hdbtextbundle"
            });
