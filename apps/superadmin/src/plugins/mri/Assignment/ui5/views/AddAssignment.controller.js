sap.ui.define([
	...
	var defaultEntity = "O";
	var AddAssignmentController = Controller.extend("sap.hc.hph.config.assignment.ui.views.AddAssignment");
	...
	AddAssignmentController.prototype._initModel = function() {
		...
		oModel.loadData(jQuery.sap.getModulePath("sap.hc.hph.config.assignment.ui.db", "/model.json"), {}, false);
  ...
  AddAssignmentController.prototype._fetchStudies = function() {
		...
		jQuery.sap.registerModulePath("sap.hc.hph.core", "/sap/hc/hph/core");
		var that = this;
