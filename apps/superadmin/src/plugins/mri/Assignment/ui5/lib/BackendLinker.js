	...
	*/
	BackendLinker._postJson = function(oSettings, fCallback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/services/assignment.xsjs",
			type: "POST",
			dataType: "json",
	...
	BackendLinker.createAssignment = function(oSettings, fCallback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/",
			type: "POST",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
	...
	BackendLinker.updateAssignment = function(oSettings, fCallback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/id/"+oSettings.assignmentId,
			type: "PATCH",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
	...
	BackendLinker.getConfigList = function(callback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/configs",
			type: "GET",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
		},JSON.stringify({
	...
	BackendLinker.getOrgs = function(callback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/orgs",
			type: "GET",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
		},JSON.stringify({
	...
	BackendLinker.getStudies = function(callback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/studies",
			type: "GET",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
		},JSON.stringify({
	...
	BackendLinker.getUsers = function(callback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/users",
			type: "GET",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
		},JSON.stringify({
	...
	BackendLinker.deleteAssignment = function(sId, callback) {
		ConfigUtils.ajax(jQuery.extend({
			url: "/sap/hc/hph/config/assignment/id/"+sId,
			type: "DELETE",
			dataType: "json",
			contentType: "application/json; charset=utf-8"
		},JSON.stringify({
