...
// Declaration of the module. Will ensure that the containing namespace 'sap.hc.hph.config.assignment.ui.lib' exists.
	var Formatter = sap.ui.base.Object.extend("sap.hc.hph.config.assignment.ui.lib.Formatter");
	...
	Formatter.areAllSet = function() {
		...
		$.each(arguments, function(ind, obj){
			valid = valid && sap.hc.hph.config.assignment.ui.lib.Formatter.isSet(obj);
		});
		return valid;
	};
