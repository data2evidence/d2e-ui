sap.ui.define([
    ...
    "sap/hc/hph/patient/plugins/widgets/diagnoses/ui/lib/Utils",
     ...
     * @alias sap.hc.hph.patient.plugins.widgets.diagnoses.ui.Extension
     */
    var WidgetComponent = WidgetExtensionBaseComponent.extend("sap.hc.hph.patient.plugins.widgets.diagnoses.ui.Extension", {
        metadata: {
            includes: [
                "css/style.css"
            ],
            rootView: "sap.hc.hph.patient.plugins.widgets.diagnoses.ui.view.Diagnoses",
            config: {
                rootPath: "/sap/hc/hph/patient/plugins/widgets/diagnoses/ui",
