sap.ui.define([
    "jquery.sap.global",
    "sap/hc/hph/patient/plugins/tabs/documents/ui/lib/Utils",
     ...
     * @alias sap.hc.hph.patient.plugins.tabs.documents.ui.Extension
     */
    var TabExtension = TabExtensionBase.extend("sap.hc.hph.patient.plugins.tabs.documents.ui.Extension", {
        constructor: function () {
            this.oResourceModel = new ResourceModel({
                bundleUrl: "/sap/hc/hph/patient/plugins/tabs/documents/ui/i18n/text.properties"
            });
    ...
    TabExtension.prototype.getContent = function (/* mNavTargets */) {
        var oContentView = sap.ui.xmlview({
            viewName: "sap.hc.hph.patient.plugins.tabs.documents.ui.view.Documents"
        });
