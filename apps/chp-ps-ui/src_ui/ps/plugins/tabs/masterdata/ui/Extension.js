sap.ui.define([
    "jquery.sap.global",
    "sap/hc/hph/patient/plugins/tabs/masterdata/ui/lib/Utils",
    ...
    /**
     * Patient Summary Masterdata Tab Extension.
     * @constructor
     *
     * @extends sap.hc.hph.patient.ui.content.extension.TabExtensionBase
     * @alias sap.hc.hph.patient.plugins.tabs.masterdata.ui.Extension
     */
    var TabExtension = TabExtensionBase.extend("sap.hc.hph.patient.plugins.tabs.masterdata.ui.Extension", {
        constructor: function () {
            this.oResourceModel = new ResourceModel({
                bundleUrl: "/sap/hc/hph/patient/plugins/tabs/masterdata/ui/i18n/text.properties"
            });
    ...
    TabExtension.prototype.getContent = function (/* mNavTargets */) {
        var oContentView = sap.ui.xmlview({
            viewName: "sap.hc.hph.patient.plugins.tabs.masterdata.ui.view.Masterdata"
        });
    ...
    TabExtension.prototype.getText = function () {
        return Utils.getText("PS_PLUGINS_TABS_MAST_TITLE");
    };
