...
import { PythonDrawer } from "./PythonNotebookDrawer";
import "./PythonNotebookNode.scss";

export interface PythonNotebookNodeData extends NodeDataState {
  python_code: string;
}

export const PythonNotebookNode = (node: NodeProps<PythonNotebookNodeData>) => {
  const { data } = node;
  ...
  return (
    <>
      <NodeLayout<PythonNotebookNodeData>
        className="python-notebook-node"
        name={data.name}
      ...
      <PythonDrawer
        node={node}
        title="Configure Python Notebook"
