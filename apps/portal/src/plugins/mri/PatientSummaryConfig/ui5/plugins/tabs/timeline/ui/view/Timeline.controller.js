sap.ui.define([
    ...
    "hc/hph/patient/app/ui/lib/timeline/ClusterTiles",
    "hc/hph/patient/app/ui/lib/timeline/MiniTileArea",
    "hc/hph/patient/app/ui/lib/PatientData",
    "hc/hph/patient/app/ui/lib/Tile",
    "hc/hph/patient/app/ui/lib/TileAnnotation",
    "hc/hph/patient/app/ui/lib/TilePopoverContent",
    "hc/hph/patient/app/ui/lib/timeline/Timeline",
    "hc/hph/patient/plugins/tabs/timeline/ui/lib/UserStateTimeline",
    "hc/hph/patient/plugins/tabs/timeline/ui/lib/Utils",
    "sap/m/GroupHeaderListItem",
    "sap/m/Popover",
    "hc/hph/patient/app/ui/lib/tab/TabBaseController",
    "sap/ui/model/Filter",
    "hc/hph/patient/shared/ZoomOptions"
     ...
     * @returns {hc.hph.patient.app.ui.lib.TileAnnotation} New TileAnnotation control.
     */
     ...
     * @returns {hc.hph.patient.app.ui.lib.Tile} Created Tile object
     */
     ...
     * @param   {hc.hph.patient.app.ui.lib.Tile[]} aTiles Array of tiles to compute the timestring for
    ...
    TimelineController.prototype.addChartLane = function (oContext) {
        ...
        oContext.getModel().setProperty(sSublanePath, {
            ...
            laneType: "ChartLane",
            mode: hc.hph.patient.app.ui.lib.timeline.ChartMode.Line,
            plottableAttributes: [],
            subLanes: [],
