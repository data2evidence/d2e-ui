sap.ui.define([
    "jquery.sap.global",
    "hc/hph/patient/plugins/tabs/overview/ui/lib/Utils",
     ...
     * @alias hc.hph.patient.plugins.tabs.overview.ui.Extension
     */
    var TabExtension = TabExtensionBase.extend("hc.hph.patient.plugins.tabs.overview.ui.Extension", {
        constructor: function () {
            this.oResourceModel = new ResourceModel({
                bundleUrl: "/hc/hph/patient/plugins/tabs/overview/ui/i18n/text.properties"
            });
    ...
    TabExtension.prototype.getContent = function (/* mNavTargets */) {
        var oContentView = sap.ui.xmlview({
            viewName: "hc.hph.patient.plugins.tabs.overview.ui.view.Overview"
        });
