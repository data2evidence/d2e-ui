sap.ui.define([], function () {
    ...
    /** @constant {hc.hph.patient.app.ui.lib.timeline.ChartMode} Default value for sublane.mode field. */
    UserStateTimeline.SUBLANE_MODE_DEFAULT_VALUE = hc.hph.patient.app.ui.lib.timeline.ChartMode.Line;

    /** @constant {hc.hph.patient.app.ui.lib.timeline.ChartMode[]} Valid values for sublane.mode field. */
    UserStateTimeline.SUBLANE_MODE_VALID_VALUES = [hc.hph.patient.app.ui.lib.timeline.ChartMode.Dot, hc.hph.patient.app.ui.lib.timeline.ChartMode.Line];
