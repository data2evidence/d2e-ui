sap.ui.define([
    ...
    "hc/hph/patient/plugins/widgets/lab/ui/lib/Utils",
     ...
     * @alias hc.hph.patient.plugins.widgets.lab.ui.Extension
     */
    var WidgetComponent = WidgetExtensionBaseComponent.extend("hc.hph.patient.plugins.widgets.lab.ui.Extension", {
        metadata: {
            includes: [
                "css/style.css"
            ],
            rootView: "hc.hph.patient.plugins.widgets.lab.ui.view.Lab",
            config: {
                rootPath: "/hc/hph/patient/plugins/widgets/lab/ui",
