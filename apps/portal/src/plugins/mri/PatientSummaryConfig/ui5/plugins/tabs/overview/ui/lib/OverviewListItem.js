sap.ui.define([
     ...
     * @alias hc.hph.patient.app.ui.lib.OverviewListItem
     */
    var OverviewListItem = ListItemBase.extend("hc.hph.patient.plugins.tabs.overview.ui.lib.OverviewListItem", {
        metadata: {
            properties: {
                /**
            ...
            aggregations: {
                 ...
                 */
                annotations: {
                    type: "hc.hph.patient.app.ui.lib.TileAnnotation",
                    multiple: true,
