sap.ui.define([
    "jquery.sap.global",
    "hc/hph/patient/plugins/tabs/lab/ui/lib/Utils",
     ...
     * @alias hc.hph.patient.plugins.tabs.lab.ui.Extension
     */
    var TabExtension = TabExtensionBase.extend("hc.hph.patient.plugins.tabs.lab.ui.Extension", {
        constructor: function () {
            this.oResourceModel = new ResourceModel({
                bundleUrl: "/hc/hph/patient/plugins/tabs/lab/ui/i18n/text.properties"
            });
    ...
    TabExtension.prototype.getContent = function (/* mNavTargets */) {
        var oContentView = sap.ui.xmlview({
            viewName: "hc.hph.patient.plugins.tabs.lab.ui.view.Lab"
        });
