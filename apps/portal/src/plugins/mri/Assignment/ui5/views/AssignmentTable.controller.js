sap.ui.define([
    ...
    var AssignmentTableController = Controller.extend("hc.hph.config.assignment.ui.views.AssignmentTable");
    ...
    AssignmentTableController.prototype.onEditPressed = function (oEvent) {
        ...
        var createAssignmentView = new sap.ui.xmlview("hc.hph.config.assignment.ui.views.AddAssignment");
