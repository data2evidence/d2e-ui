jQuery.sap.registerModulePath("hc", "/sap/hc");
...
sap.ui.define([
    ...
    var Component = UIComponent.extend("hc.hph.config.assignment.ui.Component", {
        metadata: {
            name: "HPH AssignmentConfig",
            version: "${version}",
            dependencies: {
                libs: [
                    "hc.hph.config.assignment.ui.lib",
                    "sap.m",
                    "sap.ui.commons",
                    "sap.ui.core",
                    "sap.ui.layout",
            ...
            config: {
                ...
                modulePath: "/hc/hph/config/assignment/ui",
                configService: {
                    modulePath: "/hc/hph/config",
                    resourceBundle: "i18n/text.properties"
                }
            },
            rootView: "hc.hph.config.assignment.ui.views.App"
        }
    });
    /**
