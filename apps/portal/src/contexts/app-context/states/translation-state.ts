export const i18nDefault = {
  default: {
    ...
    TREX_PLUGIN_DELETE_DIALOG__CANCEL: "Cancel",
    TREX_PLUGIN_DELETE_DIALOG__CONFIRM_1: "Are you sure you want to delete the following",
    TREX_PLUGIN_DELETE_DIALOG__CONFIRM_2: "plugin",
    TREX_PLUGIN_DELETE_DIALOG__CONFIRM_3: "Type the plugin name to confirm.",
    TREX_PLUGIN_DELETE_DIALOG__CONFIRM_DELETION: "Confirm deletion",
    TREX_PLUGIN_DELETE_DIALOG__DELETE: "Delete plugin",
    TREX_PLUGIN_DELETE_DIALOG__ENTER_EXACT_FLOW_NAME: "Enter the exact plugin name",
    TREX_PLUGIN_DELETE_DIALOG__ENTER_FLOW_NAME: "Enter plugin name",
    TREX_PLUGIN_DELETE_DIALOG__ERROR: "Plugin {0} failed to delete",
    ...
    UPDATE_STUDY_DIALOG__ADD_DASHBOARD: "add dashboard",
    ...
    UPDATE_STUDY_DIALOG__DASHBOARD: "Dashboard",
