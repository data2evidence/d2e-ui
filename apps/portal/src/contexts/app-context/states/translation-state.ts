export const i18nDefault = {
  default: {
    ...
    ACTION_SELECTOR__FHIR_CREDENTIALS: "Fhir credentials",
    ...
    EDIT_DB_DETAILS_DIALOG__SLOT: "Slot",
    EDIT_DB_DETAILS_DIALOG__UPDATE: "Update",
    EDIT_DB_DETAILS_DIALOG__VOCAB_SCHEMA: "Vocab schema",
    ...
    FHIR_PROJECT_CREDENTIALS_DIALOG__TITLE: "Fhir project client credentials for {0}",
    FHIR_PROJECT_CREDENTIALS_DIALOG__CLIENT_ID: "Client Id:",
    FHIR_PROJECT_CREDENTIALS_DIALOG__CLIENT_SECRET: "Client Secret:",
    FHIR_PROJECT_CREDENTIALS_DIALOG__LOADER: "Loading client credentials",
